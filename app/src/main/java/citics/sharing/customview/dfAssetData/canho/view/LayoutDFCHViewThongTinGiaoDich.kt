...
//
//class LayoutDFCHViewThongTinGiaoDich @JvmOverloads constructor(
//    context: Context, attrs: AttributeSet? = null, defStyle: Int = 0, defStyleRes: Int = 0
//) : LinearLayout(context, attrs, defStyle, defStyleRes) {
//    private var properties: Properties? = null
//    private var binding: LayoutDfChViewThongtingiaodichBinding
//
//
//    init {
//        binding = LayoutDfChViewThongtingiaodichBinding.inflate(LayoutInflater.from(context), this)
//
//        attrs?.let {
//            onClick()
//        }
...
//                    tylethuongluongTxt.setValue(DEFAULT)
//                }
//                gtgnt.setValue(properties.noi_that)
//                gtgntsktnt.setValue(adjustmentRates?.gia_tri_tham_dinh.toShow())
...
//                    vNoiThat.visibility = GONE
//                    gtgnt.visibility = GONE
//                    gtgntsktnt.visibility = GONE
