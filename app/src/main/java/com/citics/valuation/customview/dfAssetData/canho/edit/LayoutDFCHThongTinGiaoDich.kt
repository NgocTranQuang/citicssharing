//package com.citics.cagent.views.dfAssetData.canho.edit
//
...
//
//class LayoutDFCHThongTinGiaoDich @JvmOverloads constructor(
//    context: Context, attrs: AttributeSet? = null, defStyle: Int = 0, defStyleRes: Int = 0
//) : BaseLayoutDF(context, attrs, defStyle, defStyleRes) {
//    private var binding: LayoutDfChThongtingiaodichBinding
//    private val df = DecimalFormat("#,###.##")
//
//    init {
//        binding = LayoutDfChThongtingiaodichBinding.inflate(LayoutInflater.from(context), this)
//        attrs?.let {
//            onListenrTextChange()
//            onclick()
//        }
...
//            }
//
//            gtchsktnt.setValue(properties?.gia_tri_sau_noi_that.toCurrency())
...
//                    gtchsktnt.visibility = GONE
//                    gtgnt.visibility = GONE
