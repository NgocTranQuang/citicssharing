...
import com.citics.cagent.views.dfAssetData.nhadat.edit.BaseLayoutDF
...
//                ?: mutableListOf<String>()).toListChooser(), ChooserFragment.THAP_TYPE, ChooserItem(
...
//
//            goToChooseScreen(
//                listTang, ChooserFragment.TANG_TYPE, ChooserItem(
...
//                binding.vYeuToKhac.setListSelected(properties?.listYeuToKhacTotal?.toListSelector() ?: mutableListOf())
//            }
...
//        val bundle = intent?.getBundleExtra(SingleChoiceActivity.KEY_BUNDLE_DATA)
//        val itemSelected = bundle?.getData<ChooserItem>(ChooserFragment.LCH_DATA_KEY)
//        val typeChooser = bundle?.getInt(ChooserFragment.LCH_TYPE_KEY)
//        when (typeChooser) {
//            ChooserFragment.THAP_TYPE -> {
//                onResultThap(itemSelected?.name)
//            }
//            ChooserFragment.TANG_TYPE -> {
//                onResultTang(itemSelected?.name)
//            }
//            ChooserFragment.MCH_TYPE -> {
