package com.citics.valuation.ui.activity.hoso
...
import com.citics.cbank.databinding.ActivityHosoBinding
import com.citics.cbank.databinding.ActivityPhuongThucNhapDiemBinding

@AndroidEntryPoint
class HoSoActivity :
    BaseActivity<ActivityHosoBinding, HoSoViewModel>() {
...
//        }
    ...
    override val bindingInflater: (LayoutInflater) -> ActivityHosoBinding
        get() = ActivityHosoBinding::inflate
}