...
import com.citics.cbank.databinding.ActivityHopthoaiBinding
import com.citics.cbank.databinding.ActivityPhuongThucNhapDiemBinding

@AndroidEntryPoint
class HopThoaiActivity :
    BaseActivity<ActivityHopthoaiBinding, HopThoaiViewModel>() {
...
//        }
    ...
    override val bindingInflater: (LayoutInflater) -> ActivityHopthoaiBinding
        get() = ActivityHopthoaiBinding::inflate
}